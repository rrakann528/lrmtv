...
**سبب تعليق المشاهدين (محلول):** الـ DJ يحمّل الفيديو عبر البروكسي (download) + يُشفّر ويرسل عبر WebRTC (upload) في نفس الوقت. **الحل:** حد أقصى للـ bitrate في WebRTC: فيديو 2.5 Mbps + صوت 128 kbps + `degradationPreference: maintain-framerate` (لو الاتصال ضعيف ينزل الـ resolution بدل ما تتجمّد الصورة)
